...
public class OrientedBoundingBox3D
{
    ...
    /// <summary>
    /// Transforms the points of the oriented bounding box by a given matrix.
    /// </summary>
    /// <param name="transform">The transformation matrix that the points of the box will be transformed by.</param>
