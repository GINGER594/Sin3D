...
/// <summary>
/// A camera class for use in rendering.
/// </summary>
public class Camera3D
{
    ...
    float fov;
    /// <summary>
    /// The field of view (in radians) (the setter will only assign fov a value between 0 and PI).
    /// </summary>
    public float Fov
    {
        get => fov;
    ...
    /// <param name="_graphicsDevice">The GraphicsDevice (used for creating the projection matrix).</param>
    ...
    /// <summary>
    /// Updates the view matrix (to be used after changing position or rotation).
    /// </summary>
    ...
    /// <summary>
    /// Updates the projection matrix (to be used after changing fov or the near/far plane distance).
    /// </summary>
